...
public class Messages extends NLS
{
    ...
    public static String LabelEURGBBY10Y;
    public static String LabelEURGBBY2Y;
    public static String LabelEURGBBY3Y;
    public static String LabelEURGBBY5Y;
    public static String LabelEURGBBY7Y;
    public static String LabelEURIBOR1M;
    public static String LabelEURIBOR1Y;
    public static String LabelEURIBOR3M;
    public static String LabelEURIBOR6M;
    ...
    public static String LabelGBPLIBOR3M;
    ...
    public static String LabelTradeCalendarFirstOfTheMonth;
